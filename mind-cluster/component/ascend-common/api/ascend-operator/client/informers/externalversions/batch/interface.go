...
// Package batch is used to define interfaces.
package batch

import (
	"ascend-common/api/ascend-operator/client/informers/externalversions/batch/v1"
...
// V1 returns a new v1alpha1.Interface.
